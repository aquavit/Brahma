    ...
    internal sealed class HLSLGenerator: ExpressionVisitor
    {
        ...
        protected override Expression VisitMemberAccess(MemberExpression m)
        {
            ...
            if ((m.Member.DeclaringType.IsOutput()) &&
                ...
                (m.Expression == null))
            {
                _code.Append("((int)(texCoord.x * _brahma_minWidth))"); // We can afford to use only one component, because we know this is a DataParallelArray
                return m;
            }
                ...
                (m.Expression == null))
            {
                ...
                {
                    case "CurrentX":
                        _code.Append("((int)(texCoord.x * _brahma_minWidth))"); // We know this is CurrentX of a DataParallArray2D
                        return m;

                    case "CurrentY":
                        _code.Append("((int)(texCoord.y * _brahma_minHeight))"); // We know this is CurrentY of a DataParallArray2D
                        return m;
                }
            }
